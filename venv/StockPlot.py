...
#area_chart = px.area(df['adjclose'], title = 'FACEBOOK SHARE PRICE (2013-2020)')
...
candlestick = go.Figure(data = [go.Candlestick(x = stocks.index,
                                               open = stocks[('Open',    'GOOGL')],
                                               high = stocks[('High',    'GOOGL')],
                                               low = stocks[('Low',    'GOOGL')],
                                               close = stocks[('Close',    'GOOGL')])])

candlestick.update_layout(xaxis_rangeslider_visible = False, title = 'GOOGL SHARE PRICE (2013-2020)')
candlestick.update_xaxes(title_text = 'Date')
candlestick.update_yaxes(title_text = 'GOOGL Close Price', tickprefix = '$')
...
c_candlestick.update_layout(
    title = {
        'text': 'GOOGL SHARE PRICE (2013-2020)',
        'y':0.9,
        'x':0.5,
        'xanchor': 'center',
        'yanchor': 'top'})
c_candlestick.update_yaxes(title_text = 'GOOGL Close Price', tickprefix = '$')
